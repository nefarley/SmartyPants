...
class Definitions(@NonNull @ColumnInfo(name = "id") val id: Int,
                @PrimaryKey @NonNull @ColumnInfo(name ="letter") val letter: String,
                @NonNull @ColumnInfo(name = "word") val word: String,
                @NonNull @ColumnInfo(name = "pronounce") val pronounce: String,
